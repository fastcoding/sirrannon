 ...
 * $Id: psi.c 108 2005-04-19 12:33:21Z gbazin $
 *
 ...
 *****************************************************************************/
#ifndef XSTREAM_CRC32
#define XSTREAM_CRC32
...
inline uint32_t mpeg_crc32(uint8_t data_byte, uint32_t i_crc)
{
	return (i_crc << 8) ^ s_crc32_table[(i_crc >> 24) ^ (data_byte)];
}
