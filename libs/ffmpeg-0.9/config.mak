...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-debug=3 --disable-vaapi --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-ffplay --enable-memalign-hack --enable-version3 --enable-nonfree --enable-gpl --enable-postproc --enable-pthreads --enable-libvorbis --enable-libfaac --enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libtheora --enable-libvpx --enable-libx264 --extra-cflags=-fexceptions
prefix=/usr/local
...
EXTRALIBS=-lasound -lSDL -lx264 -lvpx -lvpx -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lopencore-amrwb -lopencore-amrnb -lmp3lame -lfaac -lm -pthread -lbz2 -lz 
INSTALL=install
LIBTARGET=
...
ACODEC_TESTS=ac3_fixed adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam alac aref flac g722 g723_1 g726 mp2 pcm_alaw pcm_f32be pcm_f32le pcm_f64be pcm_f64le pcm_mulaw pcm_s16be pcm_s16le pcm_s24be pcm_s24daud pcm_s24le pcm_s32be pcm_s32le pcm_s8 pcm_u8 wmav1 wmav2 
...
LAVF_TESTS=aiff alaw asf au avi bmp caf dv_fmt ffm flv_fmt gif gxf jpg mkv mmf mov mpg mulaw mxf mxf_d10 nut ogg pbmpipe pcx pgm pgmpipe pixfmt png ppm ppmpipe rm rso sgi sox swf tga tiff ts voc voc_s16 wav wtv yuv4mpeg 
