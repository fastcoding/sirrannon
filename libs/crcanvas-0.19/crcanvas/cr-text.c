...
get_device_extents(CrText *text, cairo_t *c, CrDeviceBounds *device)
{
        ...
        /* Because this item does not mix both device and item coordinates, 
         * the device anchor can be tied anywhere. */
        ...
        switch (text->anchor) {
                ...
                case GTK_ANCHOR_S:
                        device->x1 = -w/2 + text->x_offset;
                        device->x2 = w/2 + text->x_offset;
                        break;
                case GTK_ANCHOR_NE:
                case GTK_ANCHOR_E:
                case GTK_ANCHOR_SE:
                        device->x1 = -w + text->x_offset;
                        device->x2 = 0 + text->x_offset;
                        break;
                case GTK_ANCHOR_NW:
                case GTK_ANCHOR_W:
                case GTK_ANCHOR_SW:
        ...
        switch (text->anchor) {
                ...
                case GTK_ANCHOR_CENTER:
                case GTK_ANCHOR_E:
                        device->y1 = -h/2 + text->y_offset;
                        device->y2 = h/2 + text->y_offset;
                        break;
                case GTK_ANCHOR_SW:
                case GTK_ANCHOR_S:
                case GTK_ANCHOR_SE:
                        device->y1 = -h + text->y_offset;
                        device->y2 = 0 + text->y_offset;
                        break;
                case GTK_ANCHOR_NW:
                case GTK_ANCHOR_N:
                case GTK_ANCHOR_NE:
        ...
        g_object_class_install_property
                (object_class,
                 ...
                 g_param_spec_enum ("anchor", "anchor", "The part of the "
                         "text that is referenced to the item's x, y "
                         "coordinates",
